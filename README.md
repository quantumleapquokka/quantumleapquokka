...
- **Technologies**: Canva, Adobe Fresco, Microsoft Visual Studio, Visual Studio Code, GitHub, Git, Figma
...
- **Computer Science: Game Design** (B.S)
  - Relevant coursework: Programming Abstractions in Python, Foundations of Video Game Design, Object Oriented Programming with C++, Computer Systems and Assembly Language, Computer Systems and C Programming, Computer Networks, Database Systems,  
